...
<p><b>Email id:</b>{detail.email}</p>
 
 
 
                 
 
<p><b>Mobile no :</b>{detail.mobileNumber}</p>
...
<p>To secure a challenging position in a
            ...
            <div class="Experience">
                <h2>Experience</h2>
                <h3>Abc webdev pvt ltd - Associate Web Developer</h3>
...
<p>This project is based on html
    ...
    <p><b>Click Here To Edit Personal Detail</b></p>
    <button type="Submit" className="btn btn-danger  mb-3" style ={butt} onClick={()=>window.location.href="/edit"} >Edit</button>
    </div>
  )
}
